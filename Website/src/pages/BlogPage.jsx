  ...
  return (
    <div className="w-full relative top-10 xs:top-16 sm:top-24 px-4 lg:px-14 pt-16 pb-56 flex flex-col gap-y-12">
      {blog.map((item, index) => {
        return (
          <div
            className="w-full bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 border-2"
            key={index}
          >
            <div className="w-full md:w-[750px] xl:w-[950px] lg:h-[600px]">
              <img
                src={item?.blogImage[0]}
