...
const ContactPage = () => {
  return (
    <div className="w-full">
      ...
      <section className="py-10 md:py-16 px-4 lg:px-20 bg-gray-50">
        <div className="max-w-5xl mx-auto text-center">
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-4" data-aos="fade-up">
            We’d Love to Hear From You
          </h3>
          <p className="text-base md:text-xl text-gray-600 mb-12 leading-relaxed" data-aos="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
            ...
            <ContactCard
              Icon={FaLocationDot}
              title="Visit Us"
              description="Vikas Khand, Gomtinagar, Lucknow, Uttar Pradesh"
            />
          </div>
        </div>
      </section>
