...
const ServiceDetails = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl px-6 lg:px-12 py-10 lg:py-14">
        {service?.description ? (
          <div className="text-gray-700 text-base lg:text-lg leading-relaxed text-justify ">
