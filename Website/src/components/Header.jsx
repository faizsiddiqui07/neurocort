  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-x-5">
          ...
          <div className="flex items-center space-x-4 relative">
            ...
            <div
              ...
              className="w-8 xs:w-10 sm:hidden md:w-12 h-8 xs:h-10 md:h-12 rounded-full bg-[#a0810e] flex justify-center items-center z-50 cursor-pointer"
            >
              {isDrawerOpen ? (
      ...
      {isDrawerOpen && (
        <div
          data-aos="fade"
          className="fixed top-0 left-0 w-full h-full bg-gray-800 shadow-lg z-40 p-4"
        >
